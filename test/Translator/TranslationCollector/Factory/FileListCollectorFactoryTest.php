...
use Laminas\I18n\Translator\TranslationCollector\Factory\FileListCollectorFactory;
use LaminasTest\I18n\Translator\TranslationCollector\TestHelper;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

final class FileListCollectorFactoryTest extends TestCase
{
    ...
    public function testCollectorIsProduced(iterable $config, string $messageKey, string|null $expect): void
    {
        ...
        $collector = (new FileListCollectorFactory())->__invoke($container, 'foo');
