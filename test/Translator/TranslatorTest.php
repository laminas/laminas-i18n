...
class TranslatorTest extends TestCase
{
    ...
    {
        if (! interface_exists('Laminas\Cache\Storage\StorageInterface')) {
            $this->markTestSkipped(
                'Skipping tests that utilize laminas-cache until that component is '
    ...
    public function testTranslationsLoadedFromCache()
    {
        ...
        $cache = \Laminas\Cache\StorageFactory::factory(['adapter' => 'memory']);
    ...
    public function testGetAllMessagesLoadedInTranslator()
    {
        ...
        $this->assertInstanceOf('\Laminas\I18n\Translator\TextDomain', $allMessages);
