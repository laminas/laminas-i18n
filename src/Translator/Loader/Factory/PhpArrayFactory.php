 ...
 */
final readonly class PhpArrayFactory implements FactoryInterface
{
    public function __invoke(
        ...
        $configuredOptions = $i18n['php-loader-options'] ?? [];
        ...
        if (! is_bool($useIncludePath)) {
            throw new RuntimeException('The PHP array loader include path option must be boolean');
        }

        return new PhpArray($useIncludePath);
    }
}
